    ...
    <footer className="border-t bg-gray-50 py-12 px-4">
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm mb-4">
              strichabi-immo-demo - Ihre professionelle Plattform für intelligente 
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <a href="mailto:info@strichabi-immo-demo.de" className="hover:text-primary transition">
                  info@strichabi-immo-demo.de
                </a>
              </div>
              <div className="flex items-center gap-2">
        ...
        <div className="pt-8 border-t text-center text-sm text-muted-foreground">
          <p>© 2025 strichabi-immo-demo. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  );
